                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtStudentName" CssClass="First form-control" runat="server" PlaceHolder="Enter Student"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEnrollment" CssClass="form-control" runat="server" PlaceHolder="Enter Enrollment"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEmailInsti" CssClass="form-control" runat="server" PlaceHolder="Enter Institude Email"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtContactNo" CssClass="form-control" runat="server" PlaceHolder="Enter Contact"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="HyperLink1" SkinID="EditPopup" NavigateUrl='<%# "~/AdminPanel/Master/MST_Student/MST_StudentAddEditPopup.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#view" data-toggle="modal" runat="server"></asp:HyperLink>
