...
namespace GNForm3C.DAL
{
	public abstract class ACC_IncomeDALBase : DataBaseConfig
	{
        ...
        public DataTable SelectByHospital(SqlInt32 HospitalID)
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
                DbCommand dbCMD = sqlDB.GetStoredProcCommand("PR_HospitalWise_ACC_Income");
				sqlDB.AddInParameter(dbCMD, "@HospitalID", SqlDbType.Int, HospitalID);

                DataTable dtACC_Income = new DataTable("PR_HospitalWise_ACC_Income");
        ...
        public DataTable SelectShow(SqlInt32 FinYearID, SqlInt32 HospitalID, SqlInt32 IncomeTypeID)
        {
            ...
            try
            {
                ...
                DataTable dtMST_ExpenseTypeShow = new DataTable("PR_ACC_Income_SelectShow");
