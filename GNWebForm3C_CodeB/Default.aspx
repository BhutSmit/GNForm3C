...
<head id="Head1" runat="server">
    ...
    <link href="<%=ResolveClientUrl("~/Default/css/login.css") %>" rel="stylesheet" type="text/css" />
                                ...
                                <div class="col-md-6 margin-top-20">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="btn-container">
                                            ...
                                            <asp:LinkButton runat="server" ID="LinkButton1" CssClass="btn col-md-12 margin-bottom-20 rounded-4" OnClick="lbtnLogin_Click">
                                Login&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i>
                                            </asp:LinkButton>
                                        </div>
