<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_DSB2.aspx.cs" Inherits="AdminPanel_MST_DSB2" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="portlet box yellow">
                                                ...
                                                <div class="portlet-body" style='<%# Container.ItemIndex == 0 ? "collapse" : "expand" %>'>
                                                    <div class="row">
                                                        <div class="col-md-12"> 
