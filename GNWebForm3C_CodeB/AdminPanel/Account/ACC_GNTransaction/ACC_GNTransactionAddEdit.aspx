                                        ...
                                        <div id="newPatientForm">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-3 col-md-5">
                                                     <asp:Button ID="btnSavePatient" runat="server" SkinID="btnSave" OnClientClick="submitNewPatient(); return false;" OnClick="btnSave_ClickPatient" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<asp:Content ID="cntScripts" ContentPlaceHolderID="cphScripts" runat="Server">
    ...
    document.getElementById('btnAdd').onclick = function() {
        ...
        function submitNewPatient(e) {
            ...
            $.ajax({
                type: "POST",
                url: "AdminPanel/Account/ACC_GNTransaction/ACC_GNTransactionAddEdit.aspx/SavePatient",
                data: JSON.stringify({
                    patientName: $('#txtPatientName').val(),
                    age: $('#txtAge').val(),
                    dob: $('#dtpDOB').val(),
                    mobileNo: $('#txtMobileNo').val(),
                    primaryDesc: $('#txtPrimaryDesc').val()
                }),
