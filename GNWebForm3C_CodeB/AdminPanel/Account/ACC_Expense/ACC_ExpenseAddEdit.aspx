                    ...
                    <div class="form-horizontal" role="form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    <span class="required">*</span>
                                    <asp:Label ID="lblTagName_XXXXX" runat="server" Text="Tag"></asp:Label>
                                </label>
                                <div class="col-md-5">

                                    <asp:TextBox ID="txtTagName" CssClass="form-control" runat="server" placeholder="Tag Name"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="rfvTag" runat="server" ControlToValidate="txtTagName" ErrorMessage="Enter Tag Name"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
