...
public partial class AdminPanel_Master_MST_Branch_MST_BranchIntake : System.Web.UI.Page
{
    #region Variables
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            try
            {
                MST_BranchIntakeBAL bal_MST_BranchIntake = new MST_BranchIntakeBAL();
                ...
                if (bal_MST_BranchIntake.SaveBranchIntakeData(branchIntakeTable))
                {
                    ucMessage.ShowSuccess(CommonMessage.RecordSaved());
                }
                else
                {
                    ucMessage.ShowError(bal_MST_BranchIntake.Message);
                }
