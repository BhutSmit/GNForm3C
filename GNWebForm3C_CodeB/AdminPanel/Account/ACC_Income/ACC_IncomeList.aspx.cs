...
{ 
    ...
    protected void btnDeleteSelected_Click(object sender, EventArgs e)
    {
        foreach (RepeaterItem item in rpData.Items)
        {
            ...
            {
                // Retrieve ID of the selected item
                string incomeID = ((LinkButton)item.FindControl("lbtnDelete")).CommandArgument;
    ...
    protected void DeleteIncome(string incomeID)
    {
        ACC_IncomeBAL bal_AccIncome = new ACC_IncomeBAL();
        bal_AccIncome.Delete(Convert.ToInt32(incomeID));
